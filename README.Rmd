...
- World Bank flood extent data (`FLOOD_EXTENT_DATASET_NAME`) should be attributed with "Plan d’Élaboration propre basée sur les données de la Banque Mondiale: Inondation de Récurrence (5 ans / 25 ans / 100 ans)"
