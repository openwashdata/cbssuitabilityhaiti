...
Haiti is a island state in the Caribbean sea. It has four administrative levels where the 3rd level is used to emphasize the data through out this article. The 3rd administrative level contains `r nrow(haiti_adm3)` areas. For this article the extended area around Cap Haïtien and l'Acul-du-Nord has been explored as depicted in @fig-northern-area.
